 ...
 return(
   <div className={styles.main} >
      ...
      <main className={styles.sideA}>
         <h1 className={styles.title} >Finance Article</h1>

         <h2>Intro;</h2>
         <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Reiciendis nam minus distinctio dolorum ratione repudiandae voluptate ut explicabo quas cupiditate itaque!
         </p>


         <h3>Importance of finance</h3>
         <p>
